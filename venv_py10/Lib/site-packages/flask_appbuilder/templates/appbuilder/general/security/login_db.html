...
<div class="container">
    <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
            ...
            <div style="padding-top:30px" class="panel-body" >
                ...
                <form class="form" action="" method="post" name="login">
                    ...
                    <div class="control-group{% if form.errors.openid is defined %} error{% endif %}">
                        ...
                        <div class="col">
                            <img src="/static/appbuilder/img/captcha.png"
                                 height="200" width="300"
                              alt="CAPTCHA">
                        <input type="text" name="{{ form.captcha.name }}" size="10">
      ...
      <div class="text-dark text-center small pt-3">
                    تمامی حقوق مادی و معنوی این سامانه متعلق به
                    <a href="http://vista-group.ir/" target="_blank">گروه ایده&zwnj;سازان فناوری ویستا</a>
                    است و هرگونه کپی&zwnj;برداری بدون مجوز کتبی پیگرد قانونی دارد.
                </div>
                </div>
    </div>
  </div>
